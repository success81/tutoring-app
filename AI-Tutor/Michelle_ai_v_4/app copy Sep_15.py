...
# Updated SOCIAL_SKILLS_PROMPT with enhanced instructions for more advice and guidance
...
def get_ai_response():
    ...
    if topic == 'social':
        ...
        if social_skills_interaction_count >= 13:
            full_prompt = f"""{context}
Human: {user_input}
AI: This is the 13th interaction. Provide a brief, encouraging summary of Michelle's progress in this session. Then, clearly state that the session is complete and instruct Michelle to hit the reset button if she wants to practice again. Your response should be friendly and supportive.
"""
        else:
            full_prompt = f"""{context}

Human: {user_input}
AI: Respond to Michelle's input with a focus on the social skills scenario. Ensure you refer to her by name, ask more questions to understand her perspective, engage in role-playing to enhance the learning experience, provide actionable advice and heavy clues, and maintain an encouraging and positive tone.
"""
        ...
        return jsonify({
            ...
            "session_complete": social_skills_interaction_count >= 13
        })
...
Now, using this solution, respond to Michelle's input accordingly. Prioritize the answer provided, but continue to tutor her by guiding through the problem without giving away the answer immediately. Provide additional advice and guidance to help her understand the concepts better.
...
AI:"""
        ...
        # Similar to math, but tailored for English topics
        # Example: Grammar, Literature analysis, etc.
        # Depending on the question, you might need different handling
        # For simplicity, we'll follow a similar approach
        full_prompt = f"""{context}

Provide detailed advice and guidance to help Michelle understand and improve her English skills. Offer constructive feedback and encourage her to elaborate on her answers.
...
AI:"""
        ...
        # Handle reading sessions
        full_prompt = f"""{context}

Provide detailed advice and guidance to help Michelle understand and analyze the reading material. Encourage critical thinking, support her answers with evidence, and offer constructive feedback.
...
AI:"""
        ...
        # Handle free topics or any other unspecified topics
        full_prompt = f"""{context}
Human: {user_input}
AI: Respond to Michelle's input accordingly. Always address her by name, maintain a positive and encouraging tone, provide constructive feedback, and offer advice and guidance to help her explore the topic effectively.
"""
        ai_response = basic_prompt(full_prompt)
        return jsonify({"response": ai_response})
