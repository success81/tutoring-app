...
4. **Fundamentals:**
   - Discuss the fundamentals involved in learning the skill to solve the problem or acquire the skill.
   - Give 5-6 tips or exercises on improving fundamentals.
   - Give excercises that can help with this
...
Please format your response with clear headings and subheadings for each section and subsection. Provide a thorough and insightful analysis that will be valuable for Michelle's educational development."""
    ...
    # Generate PDF with the combined evaluation
