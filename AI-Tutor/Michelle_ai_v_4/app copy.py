...
def get_ai_response():
    ...
    if topic == 'math':
        ...
        full_prompt = f"{context}\nHuman: {user_input}\nMath Solution: {math_solution}\nAI: Based on the provided math solution, guide Michelle through the problem-solving process. Ask guiding questions, provide hints, and encourage her to think through each step. Avoid giving the full solution immediately."
    else:
        full_prompt = f"{context}\nHuman: {user_input}\nAI:"
